package com.aliyun.player.playbacktextureview;
 ...
 * - 清空相关引用，避免内存泄漏
 */
public class PlaybackTextureViewActivity extends AppCompatActivity {
    private static final String TAG = "PlaybackTextureView";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playback_texture_view);

        // 设置标题
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle(getString(R.string.menu_basic_playback_texture_view_title));
     ...
     * Step 1: 初始化视图组件
     * <p>
     * 获取 TextureView 并设置 SurfaceTexture 回调
     */
